...
fun EmployerPhoneVerificationScreen(
    ...
    // =============================================
    // UPDATE EMPLOYER PHONE VERIFICATION
    // =============================================

    suspend fun updateEmployerPhoneVerification(
        ...
        firestore.collection("employer_verifications").document(uid).set(
            ...
            mapOf(
                ...
                "businessPhoneVerified"
                        ...
                        to VerificationStatus.VERIFIED.name,
        ...
        // =============================================
        // LOAD LATEST EMPLOYER VERIFICATION
        // =============================================

        val employerVerification =
            firestore.collection("employer_verifications").document(uid).get().await().toObject(
                EmployerVerification::class.java
            )
        ...
        val userVerified =
            ...
            employerVerification?.businessEmailVerified ==

                    VerificationStatus.VERIFIED

                    &&

                    employerVerification.businessPhoneVerified ==

                    VerificationStatus.VERIFIED

                    &&

                    employerVerification.businessLicenseVerified ==
    ...
    Column(
        ...
        Text(
            ...
            text = "Employer Phone Verification",
                                            ...
                                            ?.addOnCompleteListener {
                                                ...
                                                CoroutineScope(
                                                    ...
                                                    try {
                                                        ...
                                                        updateEmployerPhoneVerification(
